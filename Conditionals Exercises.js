...
console.log(exercise4(1,2));
console.log(exercise4("1",1));
console.log(exercise4("h","1"));
...
console.log(exercise6(1,1,2));
console.log(exercise6(1,2,2));
console.log(exercise6(2,1,2));
...
console.log(exercise8(1,2,1,100));
console.log(exercise8(2,1,1,100));
console.log(exercise8(0,0,1,100));
...
//I had 2 issues. The first was figuring out thr syntax for isNaN for #9. Instead of looking for NaN, I wa searching for a term that checks if the data type is related to being a number.

/*The second was ensuring the order is right for #10 because 
  going based off the order given the results weren't accurate*/

//Aside from that I found it quite easy and did not find myself having to look through outside resources.
